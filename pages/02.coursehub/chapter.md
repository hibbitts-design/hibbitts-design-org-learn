...
[Grav Open Course Hub](https://github.com/hibbitts-design/grav-skeleton-course-hub) with [Git Sync](https://github.com/trilbymedia/grav-plugin-git-sync) is designed to empower tech-savvy instructors with an open and collaborative workflow not present in their current Learning Management System (LMS).
